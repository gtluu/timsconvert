...
python bin/run.py --input data/dd2 --outdir data/output/dd27 --mode raw --maldi_output_file individual --maldi_plate_map data/dd2/plate_map_1.csv --verbose
python bin/run.py --input data/dd2 --outdir data/output/dd28 --mode centroid --maldi_output_file individual --maldi_plate_map data/dd2/plate_map_1.csv --verbose
python bin/run.py --input data/dd2 --outdir data/output/dd29 --mode profile --maldi_output_file individual --maldi_plate_map data/dd2/plate_map_1.csv --verbose
python bin/run.py --input data/dd2 --outdir data/output/dd210 --mode raw --ms2_only --maldi_output_file individual --maldi_plate_map data/dd2/plate_map_1.csv --verbose
python bin/run.py --input data/dd2 --outdir data/output/dd211 --mode centroid --ms2_only --maldi_output_file individual --maldi_plate_map data/dd2/plate_map_1.csv --verbose
python bin/run.py --input data/dd2 --outdir data/output/dd212 --mode profile --ms2_only --maldi_output_file individual --maldi_plate_map data/dd2/plate_map_1.csv --verbose
